...
using SNBEdit.BspEditor.Modification.Operations.Mutation;
...
using SNBEdit.BspEditor.Tools.Selection.TransformationHandles;
using SNBEdit.BspEditor.Tools.Widgets;
using SNBEdit.Common.Shell.Components;
using SNBEdit.Common.Shell.Context;
using SNBEdit.Common.Shell.Documents;
using SNBEdit.Common.Shell.Hotkeys;
using SNBEdit.Common.Shell.Settings;
...
namespace SNBEdit.BspEditor.Tools.Selection
{
    /// <summary>
    ...
    public class SelectTool : BaseDraggableTool, ISettingsContainer
    {
        ...
        string ISettingsContainer.Name => "SNBEdit.BspEditor.Tools.SelectTool";
