...
using SunabaSDK.BspEditor.Tools.Selection.TransformationHandles;
using SunabaSDK.BspEditor.Tools.Widgets;
...
namespace SunabaSDK.BspEditor.Tools.Selection
{
    ...
    public class SelectTool : BaseDraggableTool, ISettingsContainer
    {
        ...
        string ISettingsContainer.Name => "SunabaSDK.BspEditor.Tools.SelectTool";
