using SunabaSDK.BspEditor.Controls;
using SunabaSDK.BspEditor.Controls.Layout;
using SunabaSDK.Common.Shell.Hooks;
using SunabaSDK.Common.Shell.Settings;
...
namespace SunabaSDK.BspEditor.Components
{
    /// <summary>
    ...
    public class MapDocumentControlHost : UserControl, ISettingsContainer, IUIShutdownHook, IUIStartupHook
    {
        ...
        string ISettingsContainer.Name => "SunabaSDK.BspEditor.Components.MapDocumentControlHost";
