...
{
    public class SunabaEnvironment : IEnvironment
    {
        ...
        private async Task<TextureCollection> MakeTextureCollectionAsync()
        {
            ...
            return new SunabaTextureCollection(wads.Union(sprites));
        }
        ...
        private static readonly string AutoVisgroupPrefix = typeof(SunabaEnvironment).Namespace + ".AutomaticVisgroups";
