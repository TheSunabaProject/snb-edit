...
namespace SunabaSDK.BspEditor.Environment.Sunaba
{
    ...
    [AutoTranslate]
    public class SunabaEnvironmentFactory : IEnvironmentFactory
    {
        public Type Type => typeof(SunabaEnvironment);
        public string TypeName => "SunabaEnvironment";
        public string Description { get; set; } = "Sunaba";
        ...
        {
            var env = (SunabaEnvironment)environment;
        ...
        {
            return new SunabaEnvironmentEditor();
        }
    }
}