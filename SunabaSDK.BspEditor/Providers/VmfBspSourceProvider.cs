...
using Plane = SunabaSDK.DataStructures.Geometric.Precision.Plane;
using Polyhedron = SunabaSDK.DataStructures.Geometric.Precision.Polyhedron;
using PVector3 = SunabaSDK.DataStructures.Geometric.Precision.Vector3;
