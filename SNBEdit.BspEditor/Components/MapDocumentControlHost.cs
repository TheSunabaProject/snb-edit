using SNBEdit.BspEditor.Controls;
using SNBEdit.BspEditor.Controls.Layout;
...
namespace SNBEdit.BspEditor.Components
{
    /// <summary>
    ...
    public class MapDocumentControlHost : UserControl, ISettingsContainer, IUIShutdownHook, IUIStartupHook
    {
        ...
        string ISettingsContainer.Name => "SNBEdit.BspEditor.Components.MapDocumentControlHost";
