using SNBEdit.BspEditor.Environment;
...
using Plane = SNBEdit.DataStructures.Geometric.Precision.Plane;
using Polyhedron = SNBEdit.DataStructures.Geometric.Precision.Polyhedron;
using PVector3 = SNBEdit.DataStructures.Geometric.Precision.Vector3;

namespace SNBEdit.BspEditor.Providers
{
