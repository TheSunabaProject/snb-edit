...
using SNBEdit.BspEditor.Environment.Controls;
using SNBEdit.BspEditor.Environment.Empty;
using SNBEdit.BspEditor.Primitives;
using SNBEdit.BspEditor.Providers;
using SNBEdit.BspEditor.Providers.Processors;
...
namespace SNBEdit.BspEditor.Documents
{
    /// <summary>
